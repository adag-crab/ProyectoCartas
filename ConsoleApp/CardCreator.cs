...
public static class CardCreator
{
    ...
    public static void MonsterCreator()
    {
        ...
        Program.MessagePrinter messagePrinter = (game) =>
        {
            ...
            {
                Console.WriteLine(i + 1 + ". " + (Engine.Types)i);
            }
        };
        ...
        MonsterCard monsterCard = new MonsterCard(0, name, (Engine.Types)(opcion - 1), "", "", "Normal", attackPoints, lifePoints);
    ...
    public static void PowerCardCreator()
    {
        ...
        PowerCard powerCard = new PowerCard(0, name, (Engine.Types)(opcion - 1), publicDescription, code, "", activationEnergy);
